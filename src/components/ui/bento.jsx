  ...
  return (
    <div className="pt-20 pb-20 container mx-auto bg-transparent flex flex-col p-10">
      ...
      <p className="max-w-3xl text-lg md:text-xl font-medium tracking-tight mt-2 text-slate-400">
        Peer-to-peer collision avoidance, tamper-evident ledgers, and game-theoretic optimization.
      </p>
      <div className="mt-10 grid grid-cols-1 gap-6 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
        <BentoCard
          eyebrow="Insight"
          title="3D Trajectory Propagation"
          description="High-fidelity orbital mechanics engines calculate precise conjunction margins and safety envelopes in real-time, preventing tracking errors."
          graphic={
            <div 
