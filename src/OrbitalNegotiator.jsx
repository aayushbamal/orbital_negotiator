          ...
          <div style={css.controlsBar}>
            <div style={css.sliderRow}>
              ...
              <input
                ...
                style={{
                  flex: 1,
                  background: `linear-gradient(to right, ${T.data} 0%, ${T.data} ${speedPct}%, ${T.border} ${speedPct}%, ${T.border} 100%)`
                }}
              />
            ...
            <div style={css.sliderRow}>
              ...
              <input
                ...
                style={{
                  flex: 1,
                  background: `linear-gradient(to right, ${T.ok} 0%, ${T.ok} ${zoomPct}%, ${T.border} ${zoomPct}%, ${T.border} 100%)`
                }}
              />
